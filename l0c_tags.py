...
def make_l0c_tags( module_name ):
    ...
    P( f'//' )
    P( f'assign tags_decr0_pvld = tags_fill_pvld || (tags_req0_pvld && (tags_req0_status == TAGS_HIT || tags_req0_status == TAGS_HIT_BEING_FILLED));' )
    P( f'assign tags_decr0_tag_i = tags_fill_pvld ? tags_fill_tag_i : tags_req0_tag_i;' )

    P()
    P( f'// IDLE' )
    P( f'//' )
    idle = '!xx2l0c_d_pvld && !xx2l0c_tags_fill_dat_d_pvld && tags_idle'
...
def make_tb_l0c_tags( name, module_name ):
    ...
    P( f'        req_in_use_mask     <= (req_in_use_mask & ~(fill_dat_mask | req_status_is_hit_mask | req_status_must_retry_mask)) | req_issued_mask;' )
    ...
    P( f'assign xx2l0c_tags_fill_dat_pvld = can_issue_fill && fill_elig_any_vld;' )
